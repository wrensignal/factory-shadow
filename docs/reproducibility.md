...
The GitHub release for `v0.1.0b1` publishes these evidence sources:
...
.venv/bin/python ci/verify_release.py --tag v0.1.0b1
```
...
.venv/bin/python ci/verify_release.py --tag v0.1.0b1 --dist dist
...
curl -fL \
  https://github.com/WrenSignal/factory-shadow/releases/download/v0.1.0b1/factory-shadow-proof-pairs-46-53.tar \
  -o "$HOME/Downloads/factory-shadow-proof-pairs-46-53.tar"

curl -fL \
  https://github.com/WrenSignal/factory-shadow/releases/download/v0.1.0b1/factory-shadow-proof-pair-55.tar \
  -o "$HOME/Downloads/factory-shadow-proof-pair-55.tar"

curl -fL \
  https://github.com/WrenSignal/factory-shadow/releases/download/v0.1.0b1/pair-summary-final.json \
  -o "$HOME/Downloads/pair-summary-final.json"

curl -fL \
  https://github.com/WrenSignal/factory-shadow/releases/download/v0.1.0b1/incomplete-pairs.json \
...
The `0.1.0b1` Python distribution does not authorize a new live Mission.
...
`87e54c92e9a4839c65ee65cf24f68b3bdcc500e0ba0b8a5f51ba22a254d53fe2`.
Its verified receipt digest is
`af8ed87a7c59ac6c26a6f5dad9ab19db91689f509f64cdee917431e85d46409f`.
